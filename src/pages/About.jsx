...
import { fallbackImages, getImage } from '../data/verifiedImages.js'
      ...
      <section className="section">
        <div className="container about-grid">
          <div className="sol-art" style={{ background: '#fff' }}>
            <img src={getImage(null, fallbackImages.pp)} alt="Injection PP cup customization options" width="800" height="800" style={{ width: '100%', height: 'auto', borderRadius: '12px' }} loading="lazy" />
          </div>
          <div>
